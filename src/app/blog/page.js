...
const BlogPage = () => {
  ...
  const backgroundImageStyle = {
    backgroundImage: `url('/images/blog/1_image.png')`,
  ...
  return (
    <div className="relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              Inpiration For Travel By
              <br></br>
              Real People
            </h1>
            <p className="text-lg md:text-xl lg:text-xl font-light">
      ...
      <div className="bg-white py-16 px-4 sm:px-6 lg:px-12 xl:px-20">
        ...
        <div className="text-center mt-12">
          <button className="bg-purple-700 text-white px-6 py-3 rounded-full hover:bg-purple-800 transition">
            View All <ArrowRight className="inline-block w-4 h-4 ml-2" />
          </button>
        </div>
      </div>
